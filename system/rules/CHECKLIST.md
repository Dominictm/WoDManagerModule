...
> Один файл вместо семи. `<город>` — slug города (напр. `london`); `<линейка>` ∈ vampires/fairies/mortals/werewolves/mages/hunters; `<slug>` — ASCII-слаг сущности.
...
| Документ | Назначение |
|---|---|
| `cities/<город>/archive/events.md` | События города (агрегат хроник) |
| [chronicle.md](chronicle.md) | Протокол внесения записей в хронику |
| `cities/<город>/archive/characters_index.md` | Сводник персонажей города |
| `cities/<город>/archive/political_state.md` | Карта фракций города |
| `cities/<город>/archive/rumors_elysium.md` | Слухи Элизиума d20 |
| `cities/<город>/archive/timeline.md` | Хронология города |
