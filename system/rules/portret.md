...
**Локации города** (события в городе):
```
locations/district_NN/<район>/[Название_локации]/[Название].md
```

**Локации других мест** (другие города, страны, внегородские события модуля):
```
...
- **Ночной город** — никакого дневного света
...
Визуальные референсы: ночные фотографии города + концепт-арт VtM: Bloodhunt + нуар-кинематограф
...
**Блок 1 — Место:**
`[конкретное описание локации], [город] [год], night`
